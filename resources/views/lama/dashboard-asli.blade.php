...
<div class="container-fluid">
    ...
    <div class="card-group">
        ...
        <!-- <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="card card-stats" style="margin-top: 70px;">
                <div class="card-body">
                    <div class="row">
                        <div class="col-5 col-md-4">
                            <div class="icon">
                                <i class="bi bi-file-earmark-plus-fill"  style="font-size: 4rem; color: cornflowerblue;"></i>
                            </div>
                        </div>
                        <div class="col-5 col-md-4">
                            <div class="numbers">
        ...
        <!-- <div class="d-grid gap-2 d-md-block" style="margin-top: 70px;">
            <div class="card-body">
                <button class="btn btn-danger btn-lg-20" type="button">
                    Profile Desa 
        ...
        <!-- <div class="col-sm-3" style="margin-top: 70px;">
            <div class="card border-danger">
            <div class="card-body">
                <h5 class="card-title text-left" style="font-size: large;">Special title treatment</h5>
